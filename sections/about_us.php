	...
	if(( isset($zerif_aboutus_show) && $zerif_aboutus_show != 1 ) || isset( $wp_customize ) ):
			...
			echo '<div class="container">';
				...
				echo '<div class="row">';
					...
					//echo '<img src='.get_stylesheet_directory_uri().'/images/kate.jpg class="about-img">';


					$zerif_aboutus_picture = get_theme_mod('zerif_aboutus_picture',get_stylesheet_directory_uri() . '/images/kate.jpg');
					...
					$zerif_aboutus_feature1_nr 		= get_theme_mod('zerif_aboutus_feature1_nr','10');
					...
					switch (
						...
						+ (empty($zerif_aboutus_picture) ? 0 : 1)
					...
					if( !empty($zerif_aboutus_picture) ):
						echo '<div class="col-lg-' . $colCount . ' col-md-' . $colCount . ' column">';
							echo '<img src="' . $zerif_aboutus_picture .'" data-scrollreveal="enter left after 0s over 1s" class="about-img">';
						echo '</div>';
					...
					echo '<div class="col-lg-'.$colCount.' col-md-'.$colCount.' column zerif-rtl-skills">';
						...
						if( !empty($zerif_aboutus_feature1_nr) || !empty($zerif_aboutus_feature1_title) || !empty($zerif_aboutus_feature2_text) ):
